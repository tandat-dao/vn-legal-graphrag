...
3. Decision Log trong file này (D-01…D-27) — đặc biệt D-23 (implements đa-cha), D-24 (multi-LLM + Gemini-only), D-26 (gemini-fallback demo), **D-27 (truy hồi ≠ chọn trích dẫn — nút thắt nay ở bộ sinh)**
